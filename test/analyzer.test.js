...
const semanticChecks = [
  ["variables can be printed", "x = 1; put x;"],
...
const semanticErrors = [
  ...
  ["a function used as variable", "put(sin + 1);", /expected/],
  ["an attempt to write a read-only var", "π = 3;", /The identifier π is read only/],
  ["too few arguments", "put(sin());", /Expected 1 arg\(s\), found 0/],
  ["too many arguments", "put(sin(5, 10));", /Expected 1 arg\(s\), found 2/],
]

const source = `x=sqrt(9);function f(x) {3*x;} while(true){x=3;put(0?f(x):2);}`
